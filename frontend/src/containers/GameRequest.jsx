...
const GameRequest = () => {
	...
	return (<div>
		<h1 className='mb-n pb-n'>Game Request page</h1>
		<div className='d-i mr-xl'>
			<h3>Submit a new game request</h3>
			...
			<div>
				...
				}}>Submit game request</button>
			</div>
		
		</div>
		<Sidebar title={'Recent game ideas'} items={MOCK_ITEMS_TO_DISPLAY} />
	</div>)
};
