...
public interface DiscussionsDAOMapper {
    ...
    public void addSupportRequestComment(@Param("comment") @NonNull ThreadCommentDAODTO comment);
    ...
    public void addDiscussionComment(@Param("comment") @NonNull ThreadCommentDAODTO comment);
    ...
    public void addBugReportComment(@Param("comment") @NonNull ThreadCommentDAODTO comment);
