...
public class AdministrationBuilder {
    ...
    public UserComponentDTO getOrCreateUser(@NonNull String username) {
        ...
        final List<UserNotificationDAODTO> notifications = administrationDAO.getUserNotificationPreferences(username);
        final List<UserSubscriptionDAODTO> subscriptions = administrationDAO.getUserSubscriptions(username);
